...
plot(dat$Times,dat$Global_active_power, type="l", ylab="Global Active Power",xlab='', axes=F)
axis(1,at=c(as.integer(dat$Times[1]),as.integer(dat$Times[2880/2]),as.integer(dat$Times[2880])),labels=c("Thu","Fri","Sat"))
axis(2)
box()

#plot voltage
plot(dat$Times,dat$Voltage, type="l", ylab="Voltage",xlab='datetime', axes=F)
axis(1,at=c(as.integer(dat$Times[1]),as.integer(dat$Times[2880/2]),as.integer(dat$Times[2880])),labels=c("Thu","Fri","Sat"))
axis(2)
box()
...
# plot reactive power
plot(dat$Times,dat$Global_reactive_power, type="l", ylab="Global_reactive_power",xlab='datetime', axes=F)
axis(1,at=c(as.integer(dat$Times[1]),as.integer(dat$Times[2880/2]),as.integer(dat$Times[2880])),labels=c("Thu","Fri","Sat"))
axis(2)
box()
